...
- 🎯 Entry points to execute your program using `python -m <py_srver2>` or `$ py_srver2` with basic CLI argument parsing.
...
---
# py_srver2 Flask Application

Awesome py_srver2 created by orhant
...
```bash
git clone https://github.com/orhant/py-srver2 py_srver2
cd py_srver2
make install
```
...
```bash
py_srver2 create-db   # run once
py_srver2 populate-db  # run once (optional)
py_srver2 add-user -u admin -p 1234  # ads a user
py_srver2 run
```
